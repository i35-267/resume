...
DMMにおけるAccount(ID)、Auth、Personalinfo 周りのプロダクトオーナーを経て、 2018年7月にリードナーチャリング領域を強化するチームの立ち上げを行う。2020年3月には、DMMの総合トップなどを管轄する総合トップ開発部の部長を務める。 現在はネイティブアプリの立ち上げ段階のプロダクトオーナーにも従事。
