...
現在は、DMMポイントクラブの立ち上げからグロースやID・認証を司るメンバーシップサービス部の部長、DMM全体のエンジニア組織課題（採用・育成・評価・露出等）を解決する組織である、VPoE室を兼務している。


###### 担当領域
- 事業戦略 / 財務諸表・予算管理（PL） / KPIマネジメント / プロダクトマネジメント全般 / ピープルマネジメント（1on1、評価、育成） / プロジェクトマネジメント（アジャイル、リーン）
